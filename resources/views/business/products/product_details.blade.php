	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-6">
	    				<div class="product-image-large">
	    					<img src="{{ asset('img/product1.jpg') }}" alt="Item Name">
	    				</div>
	    				<div class="colors">
	    			...
	    			<div class="col-sm-6 product-details">
	    				...
	    				<div>
	    					<p><label>Addess:</label>{{ $business_details->business_name }}</p>
	    					<p><label>Email Address:</label>{{ $business_details->email }}</p>
								...
								<div class="tab-pane active" id="tab1">
									...
									<form method="post" action="{{ route('business-review') }}">
										...
										<div>
											...
											<input type="hidden" name="business_name" value="{{ $business_details->business_name }}">
										</div>
